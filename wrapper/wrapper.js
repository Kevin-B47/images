...
const fs = require('fs');
const logFuncs = require('./log_funcs');

logFuncs.createDir();
const absoluteLogPath = logFuncs.getAbsoluteLogPath();
console.log('Log path = ' + absoluteLogPath);

var startupCmd = '';

fs.writeFile(absoluteLogPath, '', (err) => {
...
console.log('DELETING EMPTY DIRS');

exec('find . -type d -empty -print -delete');
